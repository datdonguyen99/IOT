...
APIKEY='a2980d543aebf24a7f373711b4b9b4d1'                 
OpenWMap=pyowm.OWM(APIKEY)                 


AIO_FEED_ID = ""
AIO_USERNAME = "DAT_DO"
AIO_KEY = "aio_igLP687BrSU6BKxYxlqfWtaDrK5k"
...
def data_pub():
    ...
    try:
        ...
        client.publish("bbc-temp",round(temp['temp']))
        client.publish("bbc-humid",round(humidity))
